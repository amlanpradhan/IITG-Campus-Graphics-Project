...
void drawFront(float a,float b,float c,float d,float e,float f)
{
 glPushMatrix();
 glTranslatef(a,b,c);
 glScalef(d,e,f);
...
void drawFront1(float a,float b,float c,float d,float e,float f)
{
 glPushMatrix();
 glTranslatef(a,b,c);
 glScalef(d,e,f);
 ...
 glColor3f(1.0f, 0.6f,0.8f); 
    ...
    glBegin(GL_QUADS);
    glVertex3f(1.0f,-0.5f,2.01f);
    glVertex3f(1.0f,0.5f,2.01f);
    glVertex3f(2.5f,0.5f,2.01f);
    glVertex3f(2.5f,-0.5f,2.01f);
    glEnd();
...
void drawFront2(float a,float b,float c,float d,float e,float f)
{
 glPushMatrix();
 glTranslatef(a,b,c);
 glScalef(d,e,f);
...
void drawSet1(float a,float b,float c,float d,float e,float f)
{
 glPushMatrix();
 glTranslatef(a,b,c);
 glScalef(d,e,f);
 ...
 glColor3f(1.0f, 0.6f,0.8f);
 glBegin(GL_QUADS);
    glVertex3f(-8.0f,0.0f,2.01f);
    glVertex3f(0.0f,0.0f,2.01f);
    glVertex3f(0.0f,2.5f,2.01f);
    glVertex3f(-8.0f,1.5f,2.01f);
    ...
    for(int i=0;i<=5;i++)
    {
    glVertex3f(-6.0f+i*0.8,0.3f,2.01f);
    glVertex3f(-6.0f+i*0.8,1.1f+i*0.2,2.01f);
    glVertex3f(-5.5f+i*0.8,1.1f+i*0.2,2.01f);
    glVertex3f(-5.5f+i*0.8,0.3f,2.01f);
...
void drawSet2(float a,float b,float c,float d,float e,float f)
{
 glPushMatrix();
 glTranslatef(a,b,c);
 glScalef(d,e,f);
...
void drawSet3(float a,float b,float c,float d,float e,float f)
{
 glPushMatrix();
 glTranslatef(a,b,c);
 glScalef(d,e,f);
...
void drawStairs(float a,float b,float c,float d,float e,float f,float g)
{
 glPushMatrix();
 glTranslatef(a,b,c);
 glScalef(d,e,f);
 ...
 {
 glPushMatrix();
 glTranslatef(0.0,0.0+0.2*i,0.0-0.1*i);
 glScalef(10,1.0,20.0-1.0*i); 
 glutSolidCube(0.2f);
 glPopMatrix();
 }
...
void drawSet4(float a,float b,float c,float d,float e,float f)
{
 glPushMatrix();
 glTranslatef(a,b,c);
 glScalef(d,e,f);
 ...
 glPopMatrix();
    ...
    for(int i=0;i<=5;i++)
    {
    glVertex3f(-0.9f+0.3*i,-0.2f,2.0f);
    glVertex3f(-0.9f+0.3*i,-0.8f,2.0f);
    glVertex3f(-0.7f+0.3*i,-0.8f,2.0f);
    glVertex3f(-0.7f+0.3*i,-0.2f,2.0f);
...
void drawNacBuilding(float a,float b,float c,float d,float e)
{
    glPushMatrix();
  glTranslatef(a,b,c);
