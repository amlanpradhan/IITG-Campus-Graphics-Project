...
void drawBase(float a, float b, float c, float d);
void drawRoad(float a, float b, float c, float d, float e);
void drawBusStop(float a, float b, float c, float d);
void drawPool(float a, float b, float c, float d);
void drawBuilding(float a, float b, float c, float d);
void lamp_post(float a, float b, float c, float d);
//void drawTree(float a, float b, float c, float d);
...
void drawRoad(float a, float b, float c, float d, float e)
{
	...
	glBegin(GL_QUADS);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glVertex3f(-10.0f+d, 0.0f, 1.0f);
	glVertex3f(-10.0f, 0.0f, 1.0f);
	glVertex3f(-10.0f, 0.0f, -1.0f);
	glVertex3f(-10.0f+d, 0.0f, -1.0f);
	glEnd();
	lamp_post(-10.0+(d/4),2.0f, -1.0f, 0.5f);
	lamp_post(-10.0+(2*d/4),2.0f, -1.0f, 0.5f);
	lamp_post(-10.0+(3*d/4),2.0f, -1.0f, 0.5f);
	glPopMatrix();
}
...
glPushMatrix();
	...
	glNormal3f(0.0f, 0.0f, -1.0f);
	glVertex3f(1.5f, -1.0f, -4.0f);
	glVertex3f(2.0f, -1.0f, -4.0f);
	glVertex3f(2.0f, -1.5f, -4.0f);
	...
	//glColor3f(0.1f, 0.1f, 0.99f);
	 glColor4f(0.0f, 0.0f, 1.0f, 1.0f);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glVertex3f(2.0f, -1.2f, -4.0f);
	glVertex3f(2.0f, -1.2f, 4.0f);
	glVertex3f(-2.0f, -1.2f, 4.0f);
	glVertex3f(-2.0f, -1.2f, -4.0f);
	...
	glNormal3f(0.0f, 0.0f, -1.0f);
	glVertex3f(2.001f, -1.501f, 6.0f);
	glVertex3f(2.001f, -0.501f, 6.0f);
	glVertex3f(1.501f, -0.501f, 6.0f);
	glVertex3f(1.501f, -1.501f, 6.0f);

	glColor3f(0.0f, 0.0f, 0.0f);
	glNormal3f(0.0f, 0.0f, -1.0f);
	glVertex3f(1.501f, -1.501f, 6.0f);
	glVertex3f(1.501f, -0.501f, 6.0f);
	glVertex3f(0.501f, -0.501f, 6.0f);
	glVertex3f(0.501f, -1.501f, 6.0f);
...
void drawBuilding(float a, float b, float c, float d)
{
	...
	glVertex3f(-0.5f, -0.25f, 1.51f);
	glVertex3f(0.5f, -1.0f, 1.51f);
	glVertex3f(0.5f, -0.25f, 1.51f);
