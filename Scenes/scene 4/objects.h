...
void drawGreen(float a, float b, float c, float l, float h)
{
    glPushMatrix();
    glTranslatef(a,b,c);
...
void drawLake(float a, float b, float c, float l, float h)
{
    glPushMatrix();
    glTranslatef(a,b,c);
...
void drawRoad(float a,float b,float c,float d,float e,float f)
{
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glVertex3f(-1.0f+e, 0.0f, -15.0f-d);
	glVertex3f(-1.0f, 0.0f, -15.0f-d);
	glVertex3f(-1.0f, 0.0f, -15.0f);
	glVertex3f(-1.0f+e, 0.0f, -15.0f);
	glEnd();
	glPopMatrix();     
} 
...
void CreateTreeLists(void)
{
  ...
  //glColor3f(0.0f, 1.0f, 0.0f); /* I think this was jeff allen's leaf idea */
    glBegin(GL_TRIANGLES);
