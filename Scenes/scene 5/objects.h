...
void drawBuilding(float a,float b,float c,float d,float e,float f)
{
     	glPushMatrix();
     	glTranslatef(a,b,c);
    glScalef(d,e,f);
...
void drawBoundry(float a,float b,float c,float d,float f)
{
    glPushMatrix();
    glTranslatef(a,b,c);
...
void drawGate(float a,float b,float c,float d)
{
    glPushMatrix();
    glTranslatef(a,b,c);
    glRotatef(d,0.0f,1.0f,0.0f);
...
void drawFootPath(float a,float b,float c,float d,float e,float f)
{
    glPushMatrix();
    glColor3f(1.0f,0.6f,0.0f);
   	glTranslatef(a,b,c);
...
//Hostel Starts
void drawBalcony(float a, float b, float c, float d)
{
	glPushMatrix();
	...
	glVertex3f(-1.25f, 0.9f, -1.0f);
	glVertex3f(-1.25f, 1.75f, -1.0f);
	...
	glVertex3f(-1.5f, 1.75f, -1.0f);

	//background
	glColor3f(1.0f, 1.0f, 0.0f);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glVertex3f(1.0f, 0.0f, -1.01f);
	glVertex3f(-3.0f, 0.0f, -1.01f);
	glVertex3f(-3.0f, 2.0f, -1.01f);
	glVertex3f(1.0f, 2.0f, -1.01f);
	...
	{
		glVertex3f(-3.0f+i, 0.9f, 0.0f);
		glVertex3f(-3.0f+i, 0.0f, 0.0f);
	}
	glEnd();
...
void drawFloor(float a, float b, float c, float d)
{
	...
	//Front
	glNormal3f(0.0f, 0.0f, 1.0f);
	glVertex3f(5.0f, 0.0f, -1.01f);
	glVertex3f(-5.0f, 0.0f, -1.01f);
	glVertex3f(-5.0f, 2.0f, -1.01f);
	glVertex3f(5.0f, 2.0f, -1.01f);
	...
	for(float j= -3.0f; j<= 4.5f; j+=2.5f)
		drawBalcony(j, 0.0f, 0.0f, 0.5f);
	glRotatef(180, 0.0f, 1.0f, 0.0f);
	for(float j= -3.0f; j<= 4.5f; j+=2.5f)
		drawBalcony(j, 0.0f, 4.01f, 0.5f);
	glPopMatrix();
}
...
void joinWing(float a,float b,float c,float d,float e,float f)
{
	glPushMatrix();
	glTranslatef(a,b,c);
	glScalef(d,e,f);
